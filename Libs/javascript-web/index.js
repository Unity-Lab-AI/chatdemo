// Browser-friendly API surface for Pollinations.AI (no tokens; referrer-based)
import { PolliClientWeb, getDefaultClient, setDefaultClient } from './src/client.js';
...
export function configure({ referrer = undefined, imageBase = 'https://image.pollinations.ai', textBase = 'https://text.pollinations.ai', timeoutMs = 60_000 } = {}) {
...
export { tools, mcp, pipeline, PolliClientWeb };
